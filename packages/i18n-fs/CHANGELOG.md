...
- 8a89f5c: `compareLocales`, for projects whose locales are not translations of one another.
...
- 004d8ed: Plural, ordinal and select arguments in messages, and locale-aware formatters.
...
- 79733e3: The size table now says which version it was measured from, and that claim is checked.
