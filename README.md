...
**Measured on 2026-08-31, from i18n-fs 0.7.3.** Every figure below comes from a real build. CI re-measures on each pull request and fails if this table and the binaries disagree, so a stale number cannot survive here.
